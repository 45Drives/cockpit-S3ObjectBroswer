          ...
          <div class="flex items-start justify-between gap-4 border-b border-default px-6 py-5">
            <div class="w-full text-center">
              ...
              <p class="mt-1 text-sm text-default/70">
                {{ mode === "create" ? "Create a new saved endpoint." : "Update the saved endpoint details." }}
              </p>
            </div>
            ...
            <div class="min-h-0 flex-1 overflow-y-auto px-6 py-6">
              <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div class="mb-4 md:col-span-2">
                  <label class="text-sm font-semibold text-default " for="m-name">Endpoint name</label>
                ...
                <!-- Endpoint -->
                <div class="mb-4 md:col-span-2">
                  <label class="text-sm font-semibold text-default" for="m-endpoint">Endpoint URL</label>

                  <div class="flex">
                    <input id="m-endpoint" v-model.trim="endpointHost" type="text" autocomplete="off"
                      placeholder="s3.example.com"
                      class="block w-full rounded-md border border-l-0 border-default bg-default px-3 py-2 text-sm text-default shadow-sm placeholder:text-default/60 focus:outline-none focus:ring-2 focus:ring-default" />
                  </div>

                  <div class="space-y-1">
                    <p v-if="errors.endpoint" class="text-sm text-red-600">
                      {{ errors.endpoint }}
                    </p>
                  </div>
                </div>
                ...
                <!-- Region -->
                <div class="mb-4">
                  <label class="text-sm font-semibold text-default" for="m-region">Region (optional)</label>
                ...
                <!-- Access -->
                <div class="mb-4">
                  <label class="text-sm font-semibold text-default" for="m-access">Access key</label>
                  ...
                  <p v-if="errors.accessKeyId" class="text-sm text-red-600">
                    {{ errors.accessKeyId }}
                  </p>
                </div>
                ...
                <!-- Secret -->
                <div class="mb-4 md:col-span-2">
                  <label class="text-sm font-semibold text-default" for="m-secret">Secret key</label>
                  ...
                  <p v-if="errors.secretAccessKey" class="text-sm text-red-600">
                ...
                <div class="space-y-3 md:col-span-2">
                  ...
                  <label class="flex items-start gap-3 rounded-md border border-default bg-default p-4">
                    ...
                    <div class="min-w-0">
                      <p class="text-sm font-semibold text-default">Use secure transfer (SSL/TLS)</p>
                      <p class="mt-1 text-xs text-default/70">
                        If enabled, connect using HTTPS.
                      </p>
                    </div>
                  </label>
                </div>
